...
void Noise::init3DNoiseTexture(int texSize, GLubyte* texPtr)
{
...
void Noise::init3DNoiseTexture()
{
	...
	glTexParameterf(GL_TEXTURE_3D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	glTexParameterf(GL_TEXTURE_3D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
	glTexImage3D(GL_TEXTURE_3D, 0, GL_RGBA, Noise3DTexSize, Noise3DTexSize, Noise3DTexSize
